...
CoverageEC(logging::Logger &logger, const std::experimental::filesystem::path &dir,
    ...
    std::vector<DBGGraphPath> pseudo_reads = PartialRR(dbg, readStorage);
...
//    dbg.printFastaOld(dir / "final_dbg.fasta");
    ...
    return {{"corrected_reads", res}, {"pseudo_reads", dir / "pseudo_reads.fasta"}, {"final_dbg", dir/ "final_dbg.gfa"}};
}
